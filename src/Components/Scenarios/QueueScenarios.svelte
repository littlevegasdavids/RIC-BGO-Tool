  ...
  <div class="flex flex-col">
    ...
    {#if busyScenario.length != 0}
      <div class="card shadow-lg mt-5 bg-accent">
        <div class="card-body">
          <p class="card-title text-black text-center text-3xl">
            Busy - {busyStatus}<i class="fas fa-spinner fa-spin ml-2"></i>
          </p>
    ...
    {:else if queueScenarios.length != 0}
      <div class="card shadow-lg mt-5 bg-neutral-content">
        <div class="card-body">
